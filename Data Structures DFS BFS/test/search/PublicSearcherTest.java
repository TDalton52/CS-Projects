...
public class PublicSearcherTest {
	...
	@Test
	public void testDepthFirstMaze()
	{
	...
	@Test
	public void testBreadthFirstMaze()
	{
		Maze randomMaze = new MazeGenerator(7, 3, 6).generateDFS();
		Searcher<Cell> s = new QueueBasedBreadthFirstSearcher<Cell>(randomMaze);
		List<Cell> solution = s.findSolution();
		assertTrue(s.isValidSolution(solution));
	}
}
